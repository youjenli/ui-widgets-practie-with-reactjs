...
class FixedMenuLayout extends React.Component<MenuLayout, MenuLayout> {
    ...
    render() {
        const menuItems = this.state.menuItems.map(function(item){
            return (<li><a href={item.url}>{item.name}</a></li>)
        });

        return (
            <div className="widget fixedMenuLayout">
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    ReactDOM.render(
        <FixedMenuLayout title={title} content={content} menuItems={menuItems} />,
